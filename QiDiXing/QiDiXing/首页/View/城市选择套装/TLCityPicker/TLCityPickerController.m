...
- (void)viewDidLoad {
    ...
    [cancelBarButton setTitleTextAttributes:textAttrs forState:UIControlStateNormal];
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"blueBg"] forBarMetrics:UIBarMetricsDefault];
    ...
    if (_localCityData == nil) {
        ...
        if (self.locationCityName != nil) {
            ...
            for (TLCity *item in self.cityData) {
                if ([item.shortName isEqualToString:self.locationCityName]) {
                    city = item;
                    break;
                }
            }
